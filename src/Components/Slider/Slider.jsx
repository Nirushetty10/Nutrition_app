  ...
  return (
    <div className="sliderContainer">
      ...
      <div className="progressBar">
         <div className={`${imgIndex === 0 ? "activeBar" : "bar" }`} id="first_bar" onClick={barClickHandler}>
          {imgIndex === 0 && <div  className="progress-fill" ></div>}
         </div>
         <div className={`${imgIndex === 1 ? "activeBar" : "bar"}`} id="second_bar" onClick={barClickHandler}>
         {imgIndex === 1 && <div  className="progress-fill" ></div>}
         </div>
         <div className={`${imgIndex === 2 ? "activeBar" : "bar"}`} id="third_bar" onClick={barClickHandler}>
         {imgIndex === 2 && <div  className="progress-fill"></div>}
         </div>
         <div className={`${imgIndex === 3 ? "activeBar" : "bar"}`} id="fourth_bar" onClick={barClickHandler}>
         {imgIndex === 3 && <div  className="progress-fill"></div>}
         </div>
         <div className={`${imgIndex === 4 ? "activeBar" : "bar"}`} id="fifth_bar" onClick={barClickHandler}>
         {imgIndex === 4 && <div  className="progress-fill"></div>}
         </div>
         <div className={`${imgIndex === 5 ? "activeBar" : "bar"}`} id="sixth_bar" onClick={barClickHandler}>
